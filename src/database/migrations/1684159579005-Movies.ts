...
export class Movies1684159579005 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`movie_ratings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`star_rating\` int NOT NULL, \`comments\` varchar(255) NULL, \`movie_id\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
